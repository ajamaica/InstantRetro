...
(function($) {
	var conf = {},
		...
		numMSG = 3; // set the number of messages to be show
		...
		live:"live-600", //optional, disabled by default, the number after "live-" indicates the time in seconds to wait before request the Twitter API for updates, I do not recommend to use less than 60 seconds.
...
// Reformat Date/Time
								...
								else mHTML="<div class='linelimiter'><a href='http://www.twitter.com/"+item.from_user+"' class='name'>@"+item.from_user+":</a> "+$.Juitter.textFormat(tweet)+"</div><span class='time'>"+timestamp+"</span>";
