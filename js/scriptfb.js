...
var saveImage = function (hash,obj) {
    ...
    $.ajax({
        ...
        success: function (response) {
			...
			FB.api('/me/feed', 'post', { message: body, link:'http://apps.facebook.com/instantretro/?view='+key, picture:'http://www.instantretro.com/thumb/'+key ,name: 'My vintage Photo' }, function(response) {
				if (!response || response.error) {
					alert('Error occured');
					console.log(response.error);
				} else {
					//alert('Post ID: ' + response.id);
					 window.location = "http://apps.facebook.com/instantretro/?view="+key;
				}
			});
