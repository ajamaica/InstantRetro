            ...
            success: function (a) {
                ...
                if (Modernizr.localstorage) {
                    ...
                    if (localStorage.getItem("photos_instant")) {
                        c = JSON.parse(localStorage.getItem("photos_instant"))
                    }
                    c.push(b);
                    localStorage.setItem("photos_instant", JSON.stringify(c))
                }
...
$(document).ready(function() {
    ...
    $("#ad").live("click", function (a) {
        woopraTracker.pushEvent({
            name: "Click anuncio"
        });
        var open_link = window.open('','_blank');
        open_link.location=$(this).attr('rel');
